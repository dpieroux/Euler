...
If we call I(d,n) the number of increasing numbers of n digits and starting by
d, then we have the recurrence relation: I(d,n) = Sum_(k=d..9) I(d-1, k).

Similarly if we call D(d,n) the number of decreasing numbers of n digits and
starting by d, then we have the recurrence relation: I(d,n) = 1+Sum_(k=1..d)
I(d-1, k), the "1+" accounting for the number 'd0...0'.
